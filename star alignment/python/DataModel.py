...
class ImageProcessing(object):
    ...
    def detect_star_points(img_gray, mask=None, resize_length=2200):
        ...
        while True:
            try:
                ...
                # logging.debug("img_rec percentile 99.5 = %s", np.percentile(img_rec, 99.5))
                # logging.debug("img_rec percentile 99.5 = %s", np.percentile(img_rec[mask], 99.5))
    ...
    def fine_tune_transform(feature1, feature2, init_pair_idx):
        ...
        while len(ind) < 0.6 * min(len(feature1["pts"]), len(feature2["pts"])) and k < 10:
            ...
            tf = cv2.findHomography(feature1["pts"][init_pair_idx[ind, 0]], feature2["pts"][init_pair_idx[ind, 1]],
...
if __name__ == "__main__":
    ...
    img_tmpl = u"/Users/jiajiezhang/Desktop/给八爪/IMG_{:04d}.tif"
