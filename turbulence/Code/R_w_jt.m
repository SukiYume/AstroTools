function a = R_w_jt(ref_image, x)
% This function accepts a image and a the reverse deformation matrix and
% using non-linear interpolation iterpolates the corrected pixel
% intesnities for the whole image, returning a new, adjusted image.
